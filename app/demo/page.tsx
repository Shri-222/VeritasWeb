...
const capturedAtLabel = 'Jul 10, 2026, 2:45 PM UTC';
        ...
        <section className="mt-8 overflow-hidden rounded-xl border border-cyan-400/20 bg-[#0E1929] shadow-2xl shadow-cyan-950/20">
          ...
          <div className="grid gap-8 p-6 sm:p-8 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3 text-sm"><Detail label="Captured at" value={capturedAtLabel} /><Detail label="Trigger type" value="Demo / read-only" /><Detail label="Original URL" value={sampleManifest.original_url} wide /><Detail label="Final URL" value={sampleManifest.final_url} wide /></div>
